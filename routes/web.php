...
// Route::post('/store_staff','UserController@store_staff');
// Route::get('/staff/edit/{id}','UserController@edit_staff');
// Route::post('/user_staff/update/','UserController@update_staff');
